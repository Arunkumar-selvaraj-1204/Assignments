...
### Problems:
- The use of `MemoryStream` for buffering is unnecessary—the file could be written directly from the byte array.
- Reading and printing each byte individually is very slow and inefficient, especially for large files.
